        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuComboId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_MenuCombos_MenuComboId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StripeRefundId = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PosPayments_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Discounts_Code_ApplicationUserId",
                table: "Discounts",
                columns: new[] { "Code", "ApplicationUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_MenuComboId",
                table: "OrderItems",
                column: "MenuComboId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PosPayments_StripeSessionId",
                table: "PosPayments",
